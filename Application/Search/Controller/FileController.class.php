    ...
    public function index(){
        if (IS_POST){
            ...
            if ($res['status'] == 1){
                ...
                //storeSearchIndex
                system("php /usr/local/xunsearch/sdk/php/util/Indexer.php  --build --source=mysql://root:deelian@192.168.253.128/xiakexing --sql='SELECT * FROM xd_res where id = 208889' --project=d_search");
